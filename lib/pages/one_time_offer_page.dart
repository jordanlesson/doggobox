...
class OneTimeOfferPage extends StatefulWidget {
  final User user;
  ...
  @override
  _OneTimeOfferPageState createState() => _OneTimeOfferPageState();
}

class _OneTimeOfferPageState extends State<OneTimeOfferPage> {
  List<Product> cart;
  ...
  void _navigateToNextStep() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) {
          return AnimalShelterUpsellPage(
            cart: cart,
            user: widget.user,
          );
        },
