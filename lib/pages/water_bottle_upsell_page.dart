...
class WaterBottleUpsellPage extends StatefulWidget {
  final List<Product> cart;
  final User user;

  WaterBottleUpsellPage({
    @required this.cart,
    @required this.user,
  });

  @override
  _WaterBottleUpsellPageState createState() => _WaterBottleUpsellPageState();
}

class _WaterBottleUpsellPageState extends State<WaterBottleUpsellPage> {
