...
class AnimalShelterUpsellPage extends StatefulWidget {
  final List<Product> cart;
  final User user;

  AnimalShelterUpsellPage({
    @required this.cart,
    @required this.user,
  });

  @override
  _AnimalShelterUpsellPageState createState() =>
      _AnimalShelterUpsellPageState();
}

class _AnimalShelterUpsellPageState extends State<AnimalShelterUpsellPage> {
  List<Product> cart;
