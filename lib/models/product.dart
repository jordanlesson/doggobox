...
class SmallDoggoBox extends Product {
  String id = "prod_HrioDQSO33EFnm";
...
class ReusableDogWaterBottle extends Product {
  String id = "prod_I2AZ9UASnTbqFs";
  String name = "Reusable Dog Water Bottle";
  String description =
      "A water bottle made perfect for long walks with your dog";
  int price = 3199;
}
